...
# Constants for the learning process
GAMMA = 0.99  # Discount factor for future rewards
THETA = 1e-5  # Threshold for determining policy evaluation convergence
MAX_EPISODES = 1000  # Maximum number of episodes for random policy execution
...
def execute_random_policy(env, episodes=MAX_EPISODES):
    ...
    for _ in range(episodes):
        ...
        while not done:
            ...
            # Handle different lengths of return values from env.step
    ...
    # Normalize the transition probabilities and average rewards
